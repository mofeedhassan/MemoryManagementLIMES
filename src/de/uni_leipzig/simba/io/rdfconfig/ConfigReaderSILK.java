 ...
 *
 */
public class ConfigReaderSILK extends ConfigReader 
{
...
//        	clean(silk);
	...
	public Model xmlConfigToRDFConfigExtended(String filePath) throws Exception{
		...
		String uri = LIMES.uri + sourceInfo.id.toLowerCase() + "_" + targetInfo.id.toLowerCase();
	...
	/*********************************  MAIN Method  SILK Configurations ************************************/
	...
	public static void main(String args[]) {
			...
			ConfigReaderSILK cr = new ConfigReaderSILK(); //ConfigReaderSILK

...
public class StrictlyAfterTest {
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("StrictlyAfter");
	...
	System.out.println("StrictlyAfter-requiredAtomics");
	...
	assertTrue(mapperTargetBlocks.get(0).equals(targetBlocks.get(1)));
	...
	assertTrue(m.get(0).equals(all.get(2)));
	assertTrue(m.get(1).equals(all.get(3)));
	...
	System.out.println("StrictlyAfter-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

...
public class OverlapAfterTest {
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("OverlapAfter");
	...
	System.out.println("OverlapAfter-requiredAtomics");
	...
	assertTrue(m.get(0).equals(all.get(3)));
	assertTrue(m.get(1).equals(all.get(0)));
	assertTrue(m.get(2).equals(all.get(1)));
	assertTrue(m.get(3).equals(all.get(6)));
	assertTrue(m.get(4).equals(all.get(7)));
	...
	System.out.println("OverlapAfter-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

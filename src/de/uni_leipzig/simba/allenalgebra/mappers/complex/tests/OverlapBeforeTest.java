...
public class OverlapBeforeTest {
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("OverlapBefore");
	...
	System.out.println("OverlapBefore-requiredAtomics");
	...
	assertTrue(m.get(0).equals(all.get(1)));
	assertTrue(m.get(1).equals(all.get(7)));
	assertTrue(m.get(2).equals(all.get(4)));
	assertTrue(m.get(3).equals(all.get(5)));
	System.out.println("==================================================");

    }
    @Test
    public void getMapping() {
	System.out.println("OverlapBefore-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

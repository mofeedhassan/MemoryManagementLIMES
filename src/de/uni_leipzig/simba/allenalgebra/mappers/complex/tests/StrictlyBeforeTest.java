...
public class StrictlyBeforeTest {
    public Cache source;
    public Cache target;
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("StrictlyBefore");
	...
	System.out.println("StrictlyBefore-requiredAtomics");
	...
	assertTrue(m.get(0).equals(all.get(5)));
	System.out.println("==================================================");

    }
    @Test
    public void getMapping() {
	System.out.println("StrictlyBefore-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

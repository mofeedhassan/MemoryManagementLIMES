...
public class BeginAfterEndTogetherTest {
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("BeginAfterEndTogether");
	...
	System.out.println("BeginAfterEndTogether-requiredAtomics");
	...
	assertTrue(mapperSourceBlocks.get(0).equals(sourceBlocks.get(1)));
	...
	assertTrue(m.get(0).equals(all.get(6)));
	assertTrue(m.get(1).equals(all.get(0)));
	assertTrue(m.get(2).equals(all.get(1)));
	...
	System.out.println("BeginAfterEndTogetherTest-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

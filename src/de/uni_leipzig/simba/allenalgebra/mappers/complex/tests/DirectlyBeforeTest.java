...
public class DirectlyBeforeTest {
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("DirectlyBefore");
	...
	System.out.println("DirectlyBeforeTest-requiredAtomics");
	...
	assertTrue(m.get(0).equals(all.get(4)));
	System.out.println("==================================================");
	...
	System.out.println("DirectlyBeforeTest-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

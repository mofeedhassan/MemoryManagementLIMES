...
public class BeginTogetherEndAfterTest {
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("BeginTogetherEndAfter");
	...
	System.out.println("BeginTogetherEndAfterTest-requiredAtomics");
	...
	assertTrue(m.get(2).equals(all.get(7)));
	...
	System.out.println("BeginTogetherEndAfterTest-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

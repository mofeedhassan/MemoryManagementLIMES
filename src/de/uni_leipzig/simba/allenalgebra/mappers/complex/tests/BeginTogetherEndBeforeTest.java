...
public class BeginTogetherEndBeforeTest {
    ...
    AllenAlgebraMapper mapper = AllenAlgebraFactory.getMapper("BeginTogetherEndBefore");
	...
	System.out.println("BeginTogetherEndBeforeTest-requiredAtomics");
	...
	System.out.println("BeginTogetherEndBeforeTest-getMapping");
	// collect mapper's required lists
	ArrayList<TreeMap<String, Set<Instance>>> mapperSourceBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();
	ArrayList<TreeMap<String, Set<Instance>>> mapperTargetBlocks = new ArrayList<TreeMap<String, Set<Instance>>>();

...
public class BeginBeginTest {
    public Cache source;
    public Cache target;
    public ConfigReader cR = new RDFConfigReader();
    private ArrayList<TreeMap<Long, Set<String>>> targetBlocks = new ArrayList<TreeMap<Long, Set<String>>>();
    private ArrayList<TreeMap<Long, Set<String>>> sourceBlocks = new ArrayList<TreeMap<Long, Set<String>>>();
	...
	System.out.println("BeginBeginTest-getProperties");
	...
	System.out.println("BeginBeginTest-sourceBlocks");
	...
	System.out.println("BeginBeginTest-targetBlocks");

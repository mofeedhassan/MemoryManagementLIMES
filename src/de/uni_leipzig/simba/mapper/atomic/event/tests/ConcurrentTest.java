...
public class ConcurrentTest {
    ...
    public void simpleLS() {
      ...
      //Mapping mapping = (new PPJoinPlusPlus()).getMapping(sourceInfo, targetInfo, cr.sourceInfo.var, cr.targetInfo.var, cr.metricExpression, cr.verificationThreshold);
        ...
        Mapping mapping = mapper.getLinks("concurrent(x.http://purl.org/NET/c4dm/timeline.owl#beginsAtDateTime|http://myOntology#MachineID,y.http://purl.org/NET/c4dm/timeline.owl#beginsAtDateTime|http://myOntology#MachineID)", 1.0);

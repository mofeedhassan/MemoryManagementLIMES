...
public class borderModifier extends AbstractPolygonModifier {
	...
	public static void main(String args[]) {
		...
		System.out.println("Malta in DBpedia before applying borderModifier modifier: " + maltaDbpediaPoly1.points);
		Polygon maltaDbpediapoly1G = new borderModifier().modify(maltaDbpediaPoly1, 2);
		System.out.println("Malta in DBpedia after applying borderModifier modifier: " + maltaDbpediapoly1G.points);
		System.out.println();

		System.out.println("Malta in Nuts before applying borderModifier modifier: " + maltaNutsPoly1.points);
		Polygon maltaNutsPoly1G = new borderModifier().modify(maltaNutsPoly1, 2);
		System.out.println("Malta in Nuts after applying borderModifier.java modifier: " + maltaNutsPoly1G.points);
		System.out.println("Malta in Nuts before applying borderModifier modifier: " + maltaNutsPoly2.points);
		Polygon maltaNutsPoly2G = new borderModifier().modify(maltaNutsPoly2, 2);
		System.out.println("Malta in Nuts after applying borderModifier modifier: " + maltaNutsPoly2G.points);
		System.out.println();
		
		System.out.println("Malta in LGD before applying borderModifier modifier: " + maltaLgdPoly1.points);
		Polygon maltaLgdPoly1G = new borderModifier().modify(maltaLgdPoly1, 2);
		System.out.println("Malta in LGD after applying borderModifier modifier: " + maltaLgdPoly1G.points);
	}
}
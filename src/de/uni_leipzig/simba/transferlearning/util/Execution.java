...
import de.uni_leipzig.simba.transferlearning.transfer.TransferLearner;
...
public class Execution {
    ...
    /**
     * Execute linking using run command between source and target with the given measure and threshold
     * @param source
     * @param target
     * @param measure
     * @param threshold
    ...
    /**
     * given a configuration, the method performs linking between a source and target
     * @param c
     * @return
     */

...
public class SamplingBasedPropertySimilarity implements PropertySimilarity {
    ...
    /**
     * get a cache of instances of certain size from a given class containing all their object values of specific property
     * @param c
     * @param p
     * @param endpoint
     * @param size
    ...
    public double getSimilarity(String property1, String property2, String class1, String class2, Configuration config) {
        ...
        //return average similarity value achieved by the mapping
    ...
    /**
     * expand the property into its fullname
     * @param property
     * @param config
     * @return
     */

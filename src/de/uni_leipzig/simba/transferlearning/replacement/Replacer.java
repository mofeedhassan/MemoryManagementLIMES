 ...
 */
package de.uni_leipzig.simba.transferlearning.replacement;
    ...
    public static Configuration replace(Configuration goalConfig, String goalConfigProperty, Configuration config, String property, boolean source) {
        ...
        if (source) {
            ...
            if (index == -1) {
                ...
                Map<String,String> propModification = new HashMap<>();
                propModification.put(property, "lowercase");
                goalConfig.source.functions.put(property,propModification );//add/change the function to lowercase
            ...
            if (index == -1) {
                ...
                Map<String,String> propModification = new HashMap<>();
                propModification.put(property, "lowercase");
                goalConfig.target.functions.put(property,propModification );

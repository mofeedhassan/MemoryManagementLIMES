 ...
 * @author ngonga
 */
public class SizeAwarePseudoFMeasure extends BaseMeasure implements Measure {
	
	public SizeAwarePseudoFMeasure() {
    }
...
//        System.out.println("P:"+p+"; R:"+r+"; F="+f);
    ...
    public double getPseudoPrecision(List<String> sourceUris, List<String> targetUris, Mapping result) {
        ...
        return (p*p)/(q*(double)sourceUris.size());
    }
...
//    }    
    public static void test() {
        ...
        m.add("s3", "t2", 1.0);
        m.add("s3", "t3", 1.0);
        System.out.println(new SizeAwarePseudoFMeasure().getPseudoPrecision(source.getAllUris(), target.getAllUris(),m));
        System.out.println(new SizeAwarePseudoFMeasure().getPseudoRecall(source.getAllUris(), target.getAllUris(), m));
    }

...
//	@Override
	public int compare(SearchTreeNode node1, SearchTreeNode node2) {
		...
		if(diff>0) {		
			...
			List<LinkSpec> firstAllLeaves = node1.getSpec().getAllLeaves();
			List<LinkSpec> secondAllLeaves = node1.getSpec().getAllLeaves();
...
//	@Override
	public void setEvaluationData(EvaluationData evalData) {

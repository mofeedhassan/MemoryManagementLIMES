...
import de.uni_leipzig.simba.learning.refinement.graphic.nodeHistory;
...
//	private double bestScore=0d;
	...
	public SearchTreeNode(SearchTreeNode parent, LinkSpec spec, double score, double expansionPenalty) {
		super();
		this.spec = spec;
		this.parent = parent;
		this.score = score;
...
//		expansion = spec.size();
	 ...
	 * @param score
	 */
	public SearchTreeNode(LinkSpec spec, double score, double expansionPenalty) {
		super();
		this.spec = spec;
//		this.parent = parent;
		this.score = score;

...
import de.uni_leipzig.simba.learning.acids.utility.OrderByLengthAndAlpha;
 ...
 *
 */
public class WeightedPassJoin extends WeightedEditDistanceFilter {

	public WeightedPassJoin(Property p) {
		property = p;
	}

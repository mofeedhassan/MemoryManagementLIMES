...
import de.uni_leipzig.simba.learning.acids.utility.Transform;

import de.uni_leipzig.simba.learning.acids.filters.WeightedEditDistanceExtended;

public class AcidsWeightedEditSimilarity extends AcidsStringSimilarity {

	public AcidsWeightedEditSimilarity(AcidsProperty property, int index) {
	...
	private AcidsReededFilter filter = new AcidsReededFilter(this);

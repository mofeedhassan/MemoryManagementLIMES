...
import de.uni_leipzig.simba.learning.acids.utility.ValueParser;
import de.uni_leipzig.simba.learning.acids.data.Resource;

public class AcidsNumericSimilarity extends AcidsSimilarity {
	
	private HashMap<String, Double> extrema = new HashMap<String, Double>();
	private AcidsNumericFilter filter = new AcidsNumericFilter(this);

	public AcidsNumericSimilarity(AcidsProperty property, int index) {
	...
	public int getDatatype() {
		return AcidsDatatype.TYPE_NUMERIC;
	}

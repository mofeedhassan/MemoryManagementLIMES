 ...
 *
 */
public class AcidsReededFilter extends AcidsFilter {
	
	public AcidsReededFilter(AcidsSimilarity similarity) {
		super(similarity);
	}
	...
	public ArrayList<Couple> filter(ArrayList<Couple> intersection,
		...
		double tau = Transform.toDistance(theta) / ((AcidsWeightedEditSimilarity) similarity).getMinWeight();

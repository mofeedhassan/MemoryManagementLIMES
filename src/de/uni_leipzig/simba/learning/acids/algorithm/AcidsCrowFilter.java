 ...
 *
 */
public class AcidsCrowFilter extends AcidsFilter {
		
	private AcidsWeightedNgramSimilarity wngs;
	
	public AcidsCrowFilter(AcidsSimilarity similarity) {
		super(similarity);
		wngs = (AcidsWeightedNgramSimilarity) similarity;
	}

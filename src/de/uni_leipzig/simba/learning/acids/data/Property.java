package de.uni_leipzig.simba.learning.acids.data;

import de.uni_leipzig.simba.learning.acids.filters.StandardFilter;
import de.uni_leipzig.simba.learning.acids.filters.crow.CrowFilter;
import de.uni_leipzig.simba.learning.acids.filters.numeric.NumericFilter;
...
public class Property {
	...
	public Property(String name, int datatype, int index) {
		...
		case TYPE_STRING:
			...
			break;
		case TYPE_NUMERIC:
			this.filter = new NumericFilter(this);
			break;

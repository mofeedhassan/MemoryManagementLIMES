 ...
 * @author ngonga
 */
public class NodeGreedyClustering extends NaiveClustering {

    public Map<Item, Set<Cluster>> itemClusterMap;
    
    @Override
    public Map<Integer, Cluster> cluster(Graph g, int maxSize) {
        itemClusterMap = new HashMap<>();
        Comparator<Edge> comparator = new Comparator<Edge>() {
            public int compare(Edge e1, Edge e2) {
                return e1.getSource().getWeight() + e1.getTarget().getWeight() 
                        - e2.getSource().getWeight() - e2.getTarget().getWeight(); // use your logic
            }
        };

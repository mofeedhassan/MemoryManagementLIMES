 ...
 * @author ngonga
 */
public class NaiveClustering implements Clustering {

    //itemclustermap points to integers which are the indexes of the clusters in the cluster list
    Set<Cluster> clusters;

    public NaiveClustering() {
    ...
    public Map<Integer, Cluster> cluster(Graph g, int maxSize) {
        //init
        Set<Edge> availableEdges = new HashSet<>(g.getAllEdges());
        int count = 0;
...
//            //}
//        }
        Map<Integer, Cluster> result = new TreeMap<>();
        Cluster cluster;
...
//            System.out.println("Available edges:" + availableEdges);
            ...
            Edge e = availableEdges.iterator().next();
